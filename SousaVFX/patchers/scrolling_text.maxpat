...
,
		"classnamespace" : "box",
		"rect" : [ 422.0, 253.0, 1386.0, 1066.0 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 260.0, 969.0, 56.0, 22.0 ],
					"restore" : 					{
						"FontLightingOnOff" : [ 0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 213.0, 754.0, 96.0, 22.0 ],
					"text" : "loadmess set #1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 213.0, 918.0, 376.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "int" ],
					"patching_rect" : [ 213.0, 846.0, 159.0, 56.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 5.5, 151.0, 50.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 213.0, 794.0, 167.0, 35.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 164.0, 13.0, 484.0, 35.0 ],
					"text" : "#1",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 776.0, 447.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 776.0, 502.0, 52.0, 22.0 ],
					"text" : "gate 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 557.0, 642.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 406.0, 619.0, 139.0, 21.0 ],
					"text" : "enable text"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 380.0, 617.0, 24.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 606.0, 60.0, 42.0, 42.0 ],
					"varname" : "enable_text"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 380.0, 649.0, 92.0, 22.0 ],
					"text" : "prepend enable"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 380.0, 588.0, 70.0, 22.0 ],
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 557.0, 679.0, 187.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 556.0, 276.0, 50.0, 22.0 ],
					"text" : "select 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 204.0, 214.0, 35.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 144.0, 145.0, 35.0, 22.0 ],
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 570.0, 316.0, 22.0, 22.0 ],
					"text" : "t b"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1479.0, 357.0, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 355.0, 226.0, 50.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1417.0, 357.0, 50.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1355.0, 357.0, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 355.0, 256.0, 50.0, 22.0 ],
					"varname" : "TextScaleX"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 942.0, 157.0, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 355.0, 196.0, 50.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1330.0, 232.0, 54.0, 22.0 ],
					"text" : "qlim 300"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1271.0, 232.0, 54.0, 22.0 ],
					"text" : "qlim 300"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1208.0, 232.0, 54.0, 22.0 ],
					"text" : "qlim 300"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 536.0, 492.0, 54.0, 22.0 ],
					"text" : "qlim 300"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 912.0, 747.0, 146.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 465.0, 228.0, 68.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 472.0, 211.0, 68.0, 20.0 ],
					"text" : "loop on/off"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 536.0, 228.0, 24.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 540.0, 211.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 513.0, 276.0, 32.0, 22.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1355.0, 301.0, 180.0, 26.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 254.0, 166.0, 184.279907654090493, 26.0 ],
					"text" : "Text Scale",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 576.0, 100.0, 480.561189408882456, 26.0 ],
					"text" : "Text Position",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 809.0, 157.0, 55.0, 23.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 295.0, 256.0, 54.0, 23.0 ],
					"triangle" : 0,
					"triscale" : 0.9,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 536.0, 534.0, 108.000002026557922, 23.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 550.0, 247.0, 45.5, 23.0 ],
					"triangle" : 0,
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1330.0, 265.0, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 374.0, 89.0, 50.0, 22.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1270.0, 265.0, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 192.0, 89.0, 50.0, 22.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1208.0, 265.0, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 12.0, 89.0, 50.0, 22.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 576.0, 152.0, 217.432251000000178, 26.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 468.0, 154.0, 179.5, 26.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 711.0, 188.0, 83.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 565.0, 182.0, 60.0, 22.0 ],
					"varname" : "LineSeconds"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 711.0, 258.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 711.0, 224.0, 83.0, 22.0 ],
					"text" : "expr $f1*1000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 634.0, 258.0, 22.0, 22.0 ],
					"text" : "t b"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 634.0, 188.0, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 515.0, 182.0, 46.0, 22.0 ],
					"varname" : "LineFinal"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 576.0, 188.0, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 468.0, 182.0, 43.0, 22.0 ],
					"varname" : "LineInitial"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 536.0, 354.0, 117.0, 22.0 ],
					"text" : "0., 0. 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 634.0, 316.0, 96.0, 22.0 ],
					"text" : "sprintf %f\\, %f %i"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 50.0, 234.0, 83.432250999999951, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 112.0, 301.0, 39.0, 22.0 ],
					"text" : "zl.len"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "list" ],
					"patching_rect" : [ 112.0, 271.0, 46.0, 22.0 ],
					"text" : "atoi"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 536.0, 316.0, 24.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 587.0, 211.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 1091.0, 155.0, 180.0, 47.875 ],
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 72.0, 180.0, 63.817438248931467 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 1451.0, 155.0, 180.0, 47.875 ],
					"presentation" : 1,
					"presentation_rect" : [ 370.0, 72.0, 180.0, 63.817438248931467 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 1271.0, 155.0, 180.0, 47.875 ],
					"presentation" : 1,
					"presentation_rect" : [ 190.0, 72.0, 180.0, 63.817438248931467 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 626.0, 388.0, 32.0, 22.0 ],
					"text" : "r ms"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 536.0, 430.0, 109.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 221.5, 364.0, 150.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1208.0, 363.0, 82.0, 22.0 ],
					"text" : "prepend color"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1208.0, 321.0, 48.0, 22.0 ],
					"text" : "pak f f f"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1572.0, 331.0, 87.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 307.0, 100.0, 57.0, 35.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 58.0, 145.0, 84.0, 21.0 ],
					"text" : "Textbox Index"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1884.0, 455.0, 38.0, 33.0 ],
					"text" : "text align"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1857.0, 341.0, 45.0, 35.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 18.0, 229.0, 65.0, 21.0 ],
					"text" : "Font style:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1705.0, 618.0, 60.0, 50.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 18.0, 257.0, 146.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 176.0, 363.0, 22.0, 22.0 ],
					"text" : "t b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 204.0, 483.0, 75.0, 22.0 ],
					"text" : "prepend text"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 204.0, 447.0, 200.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 170.0, 212.932251000000178, 22.0 ],
					"text" : "SOUSASTEP"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 145.0, 45.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 310.0, 214.0, 50.0, 23.0 ],
					"text" : "line $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "bang", "int" ],
					"patching_rect" : [ 204.0, 279.0, 128.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1572.0, 367.0, 24.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1572.0, 401.0, 105.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1348.0, 397.0, 107.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 912.0, 534.0, 111.999999999999545, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1689.0, 252.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1689.0, 284.0, 48.0, 23.0 ],
					"text" : "fontlist"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1705.0, 724.0, 75.0, 23.0 ],
					"text" : "tracking $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1705.0, 684.0, 52.0, 23.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 163.0, 256.0, 52.0, 23.0 ],
					"triscale" : 0.9,
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"parameter_mappable" : 0,
					"patching_rect" : [ 1884.0, 495.0, 68.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1884.0, 526.0, 56.0, 23.0 ],
					"text" : "align $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1470.0, 397.0, 70.0, 23.0 ],
					"text" : "depth $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1840.0, 402.0, 99.0, 23.0 ],
					"text" : "prepend face"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1840.0, 371.0, 87.0, 23.0 ],
					"pattrmode" : 1,
					"presentation" : 1,
					"presentation_rect" : [ 86.0, 227.0, 129.0, 23.0 ],
					"varname" : "FontStyle"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1748.0, 376.0, 74.0, 23.0 ],
					"text" : "tosymbol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1748.0, 402.0, 85.0, 23.0 ],
					"text" : "prepend font"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1689.0, 314.0, 139.0, 23.0 ],
					"pattrmode" : 1,
					"presentation" : 1,
					"presentation_rect" : [ 18.0, 199.0, 197.0, 23.0 ],
					"varname" : "FontName"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 809.0, 129.0, 55.0, 45.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 231.0, 256.0, 67.317748999999822, 26.0 ],
					"text" : "Bottom",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 877.0, 129.0, 180.0, 26.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 407.0, 194.0, 50.0, 26.0 ],
					"text" : "Z",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1417.0, 329.0, 56.0, 26.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 237.0, 224.0, 56.0, 26.0 ],
					"text" : "height",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1355.0, 329.0, 56.0, 26.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 407.0, 254.0, 56.0, 26.0 ],
					"text" : "width",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1479.0, 329.0, 56.0, 26.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 402.0, 224.0, 56.0, 26.0 ],
					"text" : "depth",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1451.0, 127.0, 180.0, 26.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 370.0, 60.0, 88.0, 26.0 ],
					"text" : "Blue",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1271.0, 127.0, 180.0, 26.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 190.0, 60.0, 88.0, 26.0 ],
					"text" : "Green",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1091.0, 127.0, 180.0, 26.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 60.0, 88.0, 26.0 ],
					"text" : "Red",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1091.0, 102.0, 540.0, 26.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 548.0, 82.0, 50.0, 45.0 ],
					"text" : "Text Color",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 669.280594704441228, 808.0, 294.0, 147.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 0.0, 745.0, 355.0 ],
					"proportion" : 0.5,
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 635.5, 460.812513589859236, 498.333330273628235, 460.812513589859236, 498.333330273628235, 260.812513351440657, 535.5, 260.812513351440657 ],
					"source" : [ "obj-210", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1883.5, 397.062513351440657, 1849.5, 397.062513351440657 ],
					"source" : [ "obj-377", 1 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-198::obj-133" : [ "scale_invert[2]", "Phase-Inversion", 1 ],
			"obj-198::obj-23" : [ "live.menu[2]", "live.menu", 0 ],
			"obj-198::obj-51" : [ "live.numbox[4]", "live.numbox", 0 ],
			"obj-198::obj-53" : [ "live.numbox[5]", "live.numbox", 0 ],
			"obj-224::obj-133" : [ "scale_invert[42]", "Phase-Inversion", 1 ],
			"obj-224::obj-23" : [ "live.menu", "live.menu", 0 ],
			"obj-224::obj-51" : [ "live.numbox", "live.numbox", 0 ],
			"obj-224::obj-53" : [ "live.numbox[1]", "live.numbox", 0 ],
			"obj-227::obj-133" : [ "scale_invert[1]", "Phase-Inversion", 1 ],
			"obj-227::obj-23" : [ "live.menu[1]", "live.menu", 0 ],
			"obj-227::obj-51" : [ "live.numbox[2]", "live.numbox", 0 ],
			"obj-227::obj-53" : [ "live.numbox[3]", "live.numbox", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
