...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 50.0, 188.0, 55.0, 22.0 ],
					"text" : "del 5000"
				}
...
,
					"patching_rect" : [ 313.0, 244.0, 104.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontname" : "Lato",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 194.0, 382.0, 29.5, 22.0 ],
					"text" : "2"
				}
...
,
					"patching_rect" : [ 178.0, 100.0, 75.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 126.0, 154.0, 29.5, 22.0 ],
					"text" : "> 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 204.0, 306.0, 33.0, 22.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 124.0, 249.0, 33.0, 22.0 ],
					"text" : "qlim"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 124.0, 188.0, 54.0, 22.0 ],
					"text" : "t 0 i"
				}
...
,
					"patching_rect" : [ 178.0, 416.0, 104.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontname" : "Lato",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 104.0, 382.0, 43.0, 22.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 90.0, 422.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 90.0, 306.0, 57.5, 42.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 124.0, 5.0, 57.5, 42.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 154.0, 466.0, 60.0, 61.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 139.0, 10.0, 27.540983200073242, 31.926803588867188 ],
					"togglemode" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 310.0, 348.0, 67.0, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 9.0, 13.0, 70.0, 27.0 ],
					"text" : "CPU",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 218.0, 260.0, 77.0, 22.0 ],
					"text" : "adstatus cpu"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 218.0, 229.0, 64.0, 22.0 ],
					"text" : "metro 250"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 90.0, 546.0, 91.0, 22.0 ],
					"text" : "adstatus switch"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 204.0, 350.0, 96.0, 25.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 58.0, 15.0, 61.0, 25.0 ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 168.5, 219.13092000000006, 227.5, 219.13092000000006 ],
					"order" : 1,
					"source" : [ "obj-854", 1 ]
				}
