...
// based on: GreatBallOfFire by mojovideotech
// based on:
...
{
	float noise = Turbulence(position * (1.45*density) + vec3(1.5, (1.5*3.15), (1.5*0.5))*TIME/12., 0.1, 1.5, 0.03) * 1.5*depth;
