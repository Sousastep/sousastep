...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 435.960602591254769, 586.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 435.960602591254769, 320.523920759019347, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 605.508964172680408, 39.510887993343204, 139.0, 50.0 ],
					"suppressinlet" : 1,
					"text" : "the umenu's order is dependent on the bpatcher argument order"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 185.0, 37.0, 150.0, 35.0 ],
					"suppressinlet" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 273.335196274932969, 100.0, 35.0, 22.0 ],
					"text" : "del 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 273.335196274932969, 65.0, 22.0, 22.0 ],
					"text" : "t b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 309.460602591254769, 161.077780353919479, 48.0, 24.0 ],
					"text" : "del 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 309.037521918381913, 190.609504027487787, 81.0, 24.0 ],
					"text" : "writeagain"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 207.660602460124551, 190.609504027487787, 89.0, 24.0 ],
					"text" : "pack store 1"
				}
...
, 			{
				"box" : 				{
					"autorestore" : "high_cross_fx_rnbo_or_plugin.json",
					"fontname" : "Silom",
					"id" : "obj-32",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 72.460602591254769, 256.031723673568308, 461.0, 24.0 ],
					"saved_object_attributes" : 					{
...
,
					"text" : "pattrstorage high_cross_fx_rnbo_or_plugin @savemode 0 @greedy 2",
					"varname" : "high_cross_fx_rnbo_or_plugin"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 7.312117247148308, 2.0, 78.0, 22.0 ],
					"varname" : "umenu[1]"
				}
...
,
					"patching_rect" : [ 211.960602591254769, 388.0, 243.0, 158.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 3.312117247148308, 26.0, 243.0, 195.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 509.008964172680294, 175.043551973372814, 365.0, 22.0 ],
					"text" : "script sendbox high_cross_fx replace plugin_high_cross_fx.maxpat"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 496.508964172680294, 134.532663980029611, 357.0, 22.0 ],
					"text" : "script sendbox high_cross_fx replace rnbo_chorus.maxpat"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 323.960602591254769, 586.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 211.960602591254769, 586.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 323.960602591254769, 320.523920759019347, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 211.960602591254769, 320.523920759019347, 30.0, 30.0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-32", 0 ],
					"midpoints" : [ 318.537521918381913, 238.014325794620845, 81.960602591254769, 238.014325794620845 ],
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-32", 0 ],
					"midpoints" : [ 217.160602460124551, 238.014325794620845, 81.960602591254769, 238.014325794620845 ],
					"source" : [ "obj-44", 0 ]
				}
