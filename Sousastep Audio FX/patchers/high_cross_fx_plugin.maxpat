...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 300.151638287444257, 674.0, 105.0, 22.0 ],
					"text" : "pack slotname 1 s"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 196.951638418574476, 614.0, 71.0, 22.0 ],
					"text" : "fromsymbol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "" ],
					"patching_rect" : [ 152.951638418574476, 575.418556639466829, 63.0, 22.0 ],
					"text" : "unpack i s"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1315.0, 746.43891747960015, 55.0, 22.0 ],
					"text" : "del 1000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 987.0, 339.166666666666629, 71.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1327.5, 100.503583251695716, 64.0, 22.0 ],
					"text" : "sel 1 2 3 4"
				}
...
, 			{
				"box" : 				{
					"id" : "obj-61",
					"items" : [ "select", "plugin", "search", "method", ",", "search", "for", "plugin", "manually", ",", "list", "all", "VST", "plugins", ",", "list", "all", "VST3", "plugins", ",", "list", "all", "AU", "plugins", "(mac", "only)" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1327.5, 66.0, 180.5, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 288.151638287444257, 384.0, 22.0, 22.0 ],
					"text" : "t b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 288.151638287444257, 334.0, 129.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 643.951638418574476, 301.333333333333314, 61.0, 22.0 ],
					"text" : "t \"get -10\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 643.951638418574476, 266.333333333333314, 96.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 722.0, 339.166666666666629, 61.0, 22.0 ],
					"text" : "pipe 1000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 722.0, 372.999999999999943, 71.0, 22.0 ],
					"text" : "fromsymbol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "plug" ],
					"patching_rect" : [ 1020.0, 228.0, 38.0, 22.0 ],
					"text" : "t plug"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1272.0, 146.0, 115.0, 22.0 ],
					"text" : "find plugin manually"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 722.0, 305.333333333333314, 109.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 903.519500392706277, 449.0, 187.0, 24.0 ],
					"restore" : [ 						{
...
,
					"text" : "pattr high_cross_fx_plugin",
					"varname" : "high_cross_fx_plugin"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 389.951638418574476, 405.546056680351171, 48.0, 24.0 ],
					"text" : "del 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 389.528557745701619, 435.077780353919479, 81.0, 24.0 ],
					"text" : "writeagain"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 288.151638287444257, 435.077780353919479, 89.0, 24.0 ],
					"text" : "pack store 1"
				}
...
, 			{
				"box" : 				{
					"autorestore" : "Tricerachorus_high_cross_fx_plugin.json",
					"fontname" : "Silom",
					"id" : "obj-32",
					"maxclass" : "newobj",
					"numinlets" : 1,
					...
					"saved_object_attributes" : 					{
						...
						"parameter_enable" : 0,
						"parameter_mappable" : 0,
						"storage_rect" : [ -15, -964, 666, -845 ]
					}
,
					"text" : "pattrstorage high_cross_fx_plugin @savemode 0",
					"varname" : "high_cross_fx_plugin[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 868.519500392706277, 731.421519600652687, 30.0, 30.0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"midpoints" : [ 1509.0, 710.0, 1137.0, 710.0, 1137.0, 287.0, 747.0, 287.0, 747.0, 297.0, 731.5, 297.0 ],
					"order" : 1,
					"source" : [ "obj-144", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-56", 0 ],
					"midpoints" : [ 1509.0, 702.0, 1120.0, 702.0, 1120.0, 601.0, 625.0, 601.0, 625.0, 554.0, 598.905480363005154, 554.0 ],
					"order" : 2,
					"source" : [ "obj-144", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 399.028557745701619, 482.482602121052537, 162.451638418574476, 482.482602121052537 ],
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-32", 0 ],
					"midpoints" : [ 297.651638287444257, 482.482602121052537, 162.451638418574476, 482.482602121052537 ],
					"source" : [ "obj-44", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 297.651638287444257, 374.0, 661.928559390789815, 374.0 ],
					"order" : 0,
					"source" : [ "obj-57", 0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "Tricerachorus_high_cross_fx_plugin.json",
