...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 505.5, 271.037104759019371, 37.0, 33.0 ],
					"text" : "close:",
					"textcolor" : [ 0.015686274509804, 0.23921568627451, 0.274509803921569, 1.0 ]
				}

			}
, 			{
				"box" : 				{
					"bgcolor" : [ 0.454901960784314, 0.572549019607843, 0.592156862745098, 0.0 ],
					"id" : "obj-28",
					"maxclass" : "button",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"outlinecolor" : [ 0.035294117647059, 0.368627450980392, 0.423529411764706, 1.0 ],
					"parameter_enable" : 0,
					"patching_rect" : [ 513.5, 292.037104759019371, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 513.5, 327.523920759019347, 45.0, 22.0 ],
					"text" : "wclose"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 281.0, 71.510887993343204, 55.0, 22.0 ],
					"text" : "pipe 100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 281.0, 110.0, 52.0, 22.0 ],
					"text" : "gate 1 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 334.664803725067031, 190.0, 35.0, 22.0 ],
					"text" : "del 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 363.664803725067031, 229.609504027487787, 63.0, 22.0 ],
					"text" : "writeagain"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 281.0, 190.0, 35.0, 22.0 ],
					"text" : "del 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 281.0, 147.0, 22.0, 22.0 ],
					"text" : "t b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 254.0, 229.609504027487787, 89.0, 24.0 ],
					"text" : "pack store 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 335.960602591254769, 633.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 335.960602591254769, 367.523920759019347, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 324.460602591254769, 140.5, 132.0, 35.0 ],
					"suppressinlet" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 12.508964172680294, 156.063447347136616, 26.0, 24.0 ],
					"text" : "t 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 12.508964172680294, 126.531723673568308, 69.0, 24.0 ],
					"text" : "deferlow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 12.508964172680294, 97.0, 69.0, 24.0 ],
					"text" : "loadbang"
				}
...
,
					"text" : "pattrstorage #1_rnbo_or_plugin @savemode 0 @greedy 2",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 87.937523563470108, 194.077780353919479, 119.0, 24.0 ],
					"style" : "messageGold",
					"text" : "storagewindow",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 95.437523563470108, 229.609504027487787, 104.0, 24.0 ],
					"style" : "messageGold",
					"text" : "clientwindow",
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 2.951638418574476, 65.5, 181.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 152.951638418574476, 500.5, 255.0, 24.0 ],
									"saved_object_attributes" : 									{
										"client_rect" : [ 100, 100, 500, 600 ],
										"parameter_enable" : 0,
										"parameter_mappable" : 0,
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-32", 0 ],
					"midpoints" : [ 22.008964172680294, 204.014325794620845, 79.960602591254769, 204.014325794620845 ],
					"order" : 1,
					"source" : [ "obj-45", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-32", 0 ],
					"midpoints" : [ 97.437523563470108, 226.014325794620845, 79.960602591254769, 226.014325794620845 ],
					"source" : [ "obj-89", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-32", 0 ],
					"midpoints" : [ 104.937523563470108, 277.014325794620845, 79.960602591254769, 277.014325794620845 ],
					"source" : [ "obj-96", 0 ]
				}
