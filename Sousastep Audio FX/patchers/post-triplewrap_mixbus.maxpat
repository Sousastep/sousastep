...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 1066.0, 812.809075306784962, 127.0, 22.0 ],
					"restore" : [ 0.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1120.0, 850.0, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 152.5, 463.0, 50.0, 22.0 ],
					"varname" : "limit_sat"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1120.0, 887.0, 111.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 921.235235353376538, 1318.48489940925856, 31.0, 22.0 ],
					"text" : "sig~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1010.0, 1318.48489940925856, 31.0, 22.0 ],
					"text" : "sig~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 912.0, 1348.48489940925856, 87.0, 22.0 ],
					"text" : "slide~ 480 480"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1010.0, 1348.48489940925856, 87.0, 22.0 ],
					"text" : "slide~ 480 480"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 899.735235353376538, 1126.484994248891326, 22.0, 22.0 ],
					"text" : "t b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 982.0, 1254.0, 29.5, 22.0 ],
					"text" : "- 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 926.863526899965109, 1254.0, 29.5, 22.0 ],
					"text" : "- 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 982.0, 1291.0, 47.0, 22.0 ],
					"text" : "clip 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 926.863526899965109, 1291.0, 47.0, 22.0 ],
					"text" : "clip 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 956.5, 1155.0, 55.0, 22.0 ],
					"text" : "r options"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 18.60579077937291, 157.33333420753479, 242.0, 170.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_initial" : [ 								{
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 18.60579077937291, 330.526321451103286, 244.0, 170.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_initial" : [ 								{
									"filetype" : "C74Snapshot",
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-59" : [ "vst~", "vst~", 0 ],
			"obj-67" : [ "Dry Input Gain", "Dry Input Gain", 0 ],
			"obj-68" : [ "Dry Output Gain", "Dry Output Gain", 0 ],
			"obj-69" : [ "Mod Output Gain", "Mod Output Gain", 0 ],
			"obj-70" : [ "Mod Input Gain", "Mod Input Gain", 0 ],
			"obj-8" : [ "low vol", "low vol", 0 ],
			"obj-85" : [ "max~[2]", "max~[2]", 0 ],
