...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 86.761904761904759, 308.579245361858625, 84.0, 26.0 ],
					"suppressinlet" : 1,
					"text" : "rate"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 86.841269841269835, 241.719496907905722, 84.0, 26.0 ],
					"suppressinlet" : 1,
					"text" : "segments"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 86.920634920634924, 174.859748453952875, 84.0, 26.0 ],
					"suppressinlet" : 1,
					"text" : "edge"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 613.0, 631.0, 69.0, 22.0 ],
					"text" : "center 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 14.5, 509.136938237454501, 180.0, 67.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 9.5, 416.136938237454501, 180.0, 67.0 ],
					"saturation" : 1.0,
					"varname" : "Pinwheel_color2"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 9.5, 343.0, 180.0, 67.0 ],
					"saturation" : 1.0,
					"varname" : "Pinwheel_color1"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 9.5, 11.0, 180.0, 50.0 ],
					"suppressinlet" : 1,
					"text" : "Pinwheel",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 592.046724438667297, 713.757002234458923, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 592.046724438667297, 671.700927793979645, 90.0, 22.0 ],
					"text" : "prepend param"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 317.5, 613.993094610363414, 89.0, 22.0 ],
					"text" : "prepend color2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 317.5, 509.136938237454501, 89.0, 22.0 ],
					"text" : "prepend color1"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 9.5, 268.375, 180.0, 66.875 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 9.5, 201.5, 180.0, 66.875 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 9.5, 134.625, 180.0, 66.875 ],
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 327.0, 150.0, 601.546724438667297, 150.0 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-17", 0 ],
					"midpoints" : [ 327.0, 255.0, 601.546724438667297, 255.0 ],
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-17", 0 ],
					"midpoints" : [ 327.0, 363.0, 601.546724438667297, 363.0 ],
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-17", 0 ],
					"midpoints" : [ 327.0, 465.0, 601.546724438667297, 465.0 ],
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-17", 0 ],
					"midpoints" : [ 327.0, 567.0, 601.546724438667297, 567.0 ],
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-17", 0 ],
					"midpoints" : [ 327.0, 657.0, 601.546724438667297, 657.0 ],
					"source" : [ "obj-15", 0 ]
				}
