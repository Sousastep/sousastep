...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -231.0, -304.0, 71.0, 22.0 ],
					"text" : "fromsymbol"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ -231.0, -375.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -231.0, -337.0, 151.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 266.0, -344.187478423118364, 195.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 212.5, -331.687478423118364, 48.0, 22.0 ],
					"text" : "pipe 10"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 345.912857437628873, -375.0, 163.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -139.5, -456.0, 125.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 231.523079027784661, -457.0, 48.0, 24.0 ],
					"text" : "del 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 231.099998354911804, -427.468276326431806, 81.0, 24.0 ],
					"text" : "writeagain"
				}
...
,
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 3.5, -267.063454559298634, 257.0, 24.0 ],
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 7.5, -457.0, 119.0, 24.0 ],
					"style" : "messageGold",
					"text" : "storagewindow",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 19.5, -427.468276326431806, 104.0, 24.0 ],
					"style" : "messageGold",
					"text" : "clientwindow",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 172.912857437628873, -705.703369000000066, 82.0, 22.0 ],
					"text" : "loadmess 110"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 58.459053285714162, -230.063454559298634, 123.0, 22.0 ],
					"restore" : 					{
						"FontLightingOnOff" : [ 0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ -48.5, -427.468276326431806, 34.0, 22.0 ],
					"style" : "messageGold",
					"text" : "read"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 149.912857437628873, -530.0, 24.0, 24.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 149.912857437628873, -465.842687680351219, 42.0, 22.0 ],
					"text" : "i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 149.912857437628873, -425.842687680351219, 52.0, 22.0 ],
					"text" : "store $1"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 17.0, -431.063454559298862, 13.0, -431.063454559298862 ],
					"source" : [ "obj-189", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-105", 0 ],
					"midpoints" : [ 29.0, -380.063454559298862, 13.0, -380.063454559298862 ],
					"source" : [ "obj-218", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-105", 0 ],
					"midpoints" : [ 240.599998354911804, -380.063454559298862, 13.0, -380.063454559298862 ],
					"source" : [ "obj-64", 0 ]
				}
