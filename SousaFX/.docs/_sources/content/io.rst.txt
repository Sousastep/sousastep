...
- Silentbrass Prerecorded 
    ...
    from "prerecorded silentbrass L / R", which connects to :ref:`SousaPlayback's "silentbrass" track <Main Track List>`.
...
- Mic Prerecorded 
    ...
    from "prerecorded mic", which connects to :ref:`SousaPlayback's "sousa mic" track <Main Track List>`.

- Mic Live Pitch Correct 
  
    from "pitch correct", which I use with a `custom algorithm <https://github.com/Sousastep/H9K_to_OBS/blob/main/H9000/stereo%20pitch%20correction.sig2>`_ on the Eventide H9000.
