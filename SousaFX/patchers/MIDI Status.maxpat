...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 2042.75, 1398.0, 129.0, 27.0 ],
					"suppressinlet" : 1,
					"text" : "MIDI Out",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 2042.75, 1306.0, 129.0, 27.0 ],
					"suppressinlet" : 1,
					"text" : "MIDI In",
					"textcolor" : [ 1.0, 0.709803921568627, 0.196078431372549, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 2042.75, 1229.0, 129.0, 27.0 ],
					"suppressinlet" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 520.0, 338.299999999999955, 80.0, 22.0 ],
					"text" : "speedlim 200"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 520.0, 468.499999999999886, 178.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 520.0, 425.099999999999909, 65.0, 22.0 ],
					"text" : "thresh 200"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 3331.0, 1578.0, 150.0, 21.0 ],
					"suppressinlet" : 1,
					"text" : "moofin"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 1325.0, 832.0, 45.0, 22.0 ],
					"text" : "t 127 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 18.0, 13.0, 126.0, 76.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 46.0, 1151.0, 40.0, 21.0 ],
					"text" : "round"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 46.0, 1177.0, 165.75, 60.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 46.0, 1125.0, 56.0, 21.0 ],
					"text" : "zl join"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 83.0, 1083.0, 158.0, 21.0 ],
					"text" : "vexpr $f1 + $f2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 46.0, 1054.0, 158.0, 21.0 ],
					"text" : "vexpr $f1 - $f2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 185.0, 981.0, 86.0, 21.0 ],
					"text" : "vexpr $i1 * 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 46.0, 1009.0, 86.0, 21.0 ],
					"text" : "vexpr $i1 * 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 46.0, 981.0, 56.0, 21.0 ],
					"text" : "zl slice 2"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 46.0, 927.0, 67.0, 21.0 ],
					"text" : "screensize"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 132.0, 839.0, 62.0, 22.0 ],
					"text" : "t b b b b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 132.0, 789.0, 120.0, 22.0 ],
					"text" : "r \"MIDI Status_open\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 143.0, 906.0, 102.0, 22.0 ],
					"text" : "title \"MIDI Status\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 191.0, 875.0, 33.0, 22.0 ],
					"text" : "front"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 71.0, 875.0, 61.0, 22.0 ],
					"text" : "topmost 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 18.0, 688.0, 67.0, 22.0 ],
