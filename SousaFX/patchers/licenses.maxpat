...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 950.0, 381.999999999999886, 78.0, 22.0 ],
					"text" : "title Licenses"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 672.0, 456.999999999999886, 67.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 672.0, 355.999999999999886, 40.0, 21.0 ],
					"text" : "round"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 672.0, 381.999999999999886, 210.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 672.0, 104.0, 297.0, 21.0 ],
					"text" : "b 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 672.0, 329.999999999999886, 56.0, 21.0 ],
					"text" : "zl join"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 709.0, 287.999999999999886, 158.0, 21.0 ],
					"text" : "vexpr $f1 + $f2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 672.0, 258.999999999999886, 158.0, 21.0 ],
					"text" : "vexpr $f1 - $f2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 811.0, 185.999999999999886, 86.0, 21.0 ],
					"text" : "vexpr $i1 * 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 672.0, 213.999999999999886, 86.0, 21.0 ],
					"text" : "vexpr $i1 * 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 672.0, 185.999999999999886, 56.0, 21.0 ],
					"text" : "zl slice 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 811.0, 154.999999999999886, 82.0, 21.0 ],
					"text" : "zl reg 608 563"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 672.0, 77.0, 58.0, 21.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 672.0, 131.999999999999886, 67.0, 21.0 ],
					"text" : "screensize"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1080.438122034072876, 128.5, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 30.0, 30.0, 450.0, 527.0 ],
					"proportion" : 0.39,
