...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "int" ],
					"patching_rect" : [ 3580.0, 814.0, 62.0, 22.0 ],
					"text" : "change -1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 976.568351651030298, 411.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 855.5, 211.0, 50.0, 22.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 565.0, 141.0, 50.0, 22.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "int" ],
					"patching_rect" : [ 658.0, 220.0, 48.0, 22.0 ],
					"text" : "change"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "int" ],
					"patching_rect" : [ 658.0, 292.0, 48.0, 22.0 ],
					"text" : "change"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 702.0, 183.0, 137.0, 22.0 ],
					"restore" : [ 0.2 ],
...
,
					"text" : "pattr auto-metro_enable",
					"varname" : "auto-metro_enable"
				}
...
, 			{
				"box" : 				{
					...
					"format" : 6,
					"hint" : "auto-enable metronome when \"Drum Clip Crossfade (bi)\" is below this value. AKA when kick & snare track is quiet / muted.",
					"id" : "obj-109",
					"maxclass" : "flonum",
					"maximum" : 0.45,
					"minimum" : -0.05,
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 675.0, 148.0, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 95.0, 163.0, 50.0, 22.0 ],
					"varname" : "number"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 658.0, 254.0, 193.5, 22.0 ],
					"text" : "OR"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 833.0, 111.0, 105.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 914.431648348969588, 370.0, 24.0, 24.0 ],
					"varname" : "toggle[2]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 658.0, 384.0, 119.0, 22.0 ],
					"text" : "OR"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 880.431648348969702, 141.0, 150.0, 50.0 ],
					"suppressinlet" : 1,
					"text" : "auto-enable metronome when kick & snare tracks are quiet / muted"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 658.0, 183.0, 36.0, 22.0 ],
					"text" : "< 0.2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 658.0, 111.0, 156.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 89.0, 326.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"pic" : "arrowdark.png",
					"presentation" : 1,
					"presentation_rect" : [ 394.5, 0.919607843137257, 40.999999999999986, 41.160784313725472 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 3580.0, 779.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 3543.0, 745.0, 56.0, 22.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 245.0, 141.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 351.0, 665.0, 85.0, 26.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 166.0, 139.0, 85.0, 26.0 ],
					"suppressinlet" : 1,
					"text" : "Restore:",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 3687.0, 660.0, 40.0, 22.0 ],
					"text" : "==~ 0"
				}
...
, 			{
				"box" : 				{
					...
					"pic" : "metrolight.png",
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 79.481609195402299, 88.999999999999986, 104.754022988505724 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 191.0, 1292.0, 700.0, 505.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 245.0, 113.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 194.0, 110.0, 57.0, 26.0 ],
					"suppressinlet" : 1,
					"text" : "Save:",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 89.0, 364.0, 113.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 244.0, 364.0, 63.0, 22.0 ],
					"text" : "closebang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 89.0, 405.0, 218.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 89.0, 448.0, 67.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 1351.0, 2260.0, 34.0, 22.0 ],
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 3810.0, 2520.0, 47.0, 22.0 ],
					"text" : ">~ -0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "bang" ],
					"patching_rect" : [ 1506.0, 1783.5, 80.0, 22.0 ],
					"text" : "play~ clickUp"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 1506.0, 1755.5, 22.0, 22.0 ],
					"text" : "t 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1506.0, 1673.0, 47.0, 22.0 ],
					"text" : ">~ -0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1506.0, 1636.5, 42.0, 22.0 ],
					"text" : "delta~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "signal", "signal", "signal" ],
					"patching_rect" : [ 1506.0, 1587.0, 91.66666666666697, 22.0 ],
					"text" : "mc.unpack~ 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "bang" ],
					"patching_rect" : [ 1406.0, 1847.5, 42.0, 22.0 ],
					"text" : "edge~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1406.0, 1804.5, 47.0, 22.0 ],
					"text" : ">~ -0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1406.0, 1762.5, 42.0, 22.0 ],
					"text" : "delta~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1406.0, 1720.5, 36.0, 22.0 ],
					"text" : "%~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1406.0, 1678.5, 54.0, 22.0 ],
					"text" : "clip~ 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1406.0, 1636.5, 30.0, 22.0 ],
					"text" : "*~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 733.0, 1826.0, 47.0, 22.0 ],
					"text" : ">~ -0.5"
				}
...
, 			{
				"box" : 				{
					...
					"bgfillcolor_angle" : 270.0,
					"bgfillcolor_autogradient" : 0.0,
					"bgfillcolor_color" : [ 0.594473705410263, 0.720560630419913, 0.928309050695498, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 2525.0, 1674.0, 47.0, 22.0 ],
					"text" : ">~ -0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1000.0, 1826.0, 47.0, 22.0 ],
					"text" : ">~ -0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 926.0, 1826.0, 47.0, 22.0 ],
					"text" : ">~ -0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 1633.0, 1601.0, 66.0, 22.0 ],
					"text" : "mc.>~ -0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 3930.0, 2231.0, 195.0, 22.0 ],
					"text" : "buffer~ beat 4000. 2 @format int24",
					"textcolor" : [ 0.996078431372549, 0.984313725490196, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1089.0, 160.0, 95.0, 22.0 ],
					"text" : "s tapped_tempo"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "int" ],
					"patching_rect" : [ 1089.0, 100.5, 452.0, 43.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 494.0, 454.0, 109.0, 22.0 ],
					"restore" : [ 0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 448.5, 569.0, 98.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 448.5, 453.0, 24.0, 24.0 ],
					"varname" : "toggle"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 914.431648348969588, 292.0, 123.0, 22.0 ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 3648.5, 2456.0, 3624.0, 2456.0, 3624.0, 1556.0, 4002.0, 1556.0, 4002.0, 594.0, 3696.5, 594.0 ],
					"order" : 0,
					"source" : [ "obj-85", 0 ]
				}
