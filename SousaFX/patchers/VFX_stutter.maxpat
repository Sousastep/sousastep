...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 543.0, 169.5, 92.0, 22.0 ],
					"text" : "r~ main_phasor",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 357.0, 229.0, 310.0, 109.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 7.5, 86.0, 319.0, 133.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1191.0, 81.0, 48.0, 22.0 ],
					"text" : "del 250"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1262.0, 116.0, 125.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1191.0, 151.0, 185.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1262.0, 186.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1022.0, 169.0, 50.5, 23.0 ],
					"text" : "b 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1022.0, 130.0, 37.0, 23.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 144.0, 221.0, 46.0, 23.0 ],
					"text" : "save",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 758.0, 138.0, 94.0, 21.0 ],
					"suppressinlet" : 1,
					"text" : "Default preset #"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1032.0, 227.0, 66.0, 23.0 ],
					"text" : "deferlow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 758.0, 169.0, 81.0, 23.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 921.0, 227.0, 95.0, 23.0 ],
					"text" : "pack store 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 758.0, 316.0, 340.0, 23.0 ],
...
,
					"text" : "pattrstorage VFX_stutter @greedy 0 @savemode 0",
					"varname" : "VFX_stutter"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 775.0, 202.0, 115.0, 23.0 ],
					"style" : "messageGold",
					"text" : "storagewindow",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 789.0, 234.0, 101.0, 23.0 ],
					"style" : "messageGold",
					"text" : "clientwindow",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1032.0, 272.0, 541.0, 23.0 ],
					"text" : "write \"~/Documents/Max 8/Projects/sousastep/SousaFX/data/VFX_stutter.json\""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 50.0, 100.0, 326.0, 70.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 4.0, 7.0, 326.0, 70.0 ],
					"varname" : "stutterLFO",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 357.0, 471.0, 30.0, 30.0 ]
				}
