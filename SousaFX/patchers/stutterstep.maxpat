...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "int" ],
					"patching_rect" : [ 565.5, 995.0, 61.0, 22.0 ],
					"text" : "change 1."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 645.0, 995.0, 42.0, 22.0 ],
					"text" : "edge~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 645.0, 960.0, 41.0, 22.0 ],
					"text" : "what~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 541.0, 1639.0, 54.0, 22.0 ],
					"text" : "clip~ 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "bang" ],
					"patching_rect" : [ 808.25, 589.0, 55.0, 22.0 ],
					"text" : "onebang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "bang" ],
					"patching_rect" : [ 769.25, 548.0, 55.0, 22.0 ],
					"text" : "onebang"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 831.0, 687.0, 100.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 192.0, 2.0, 49.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "Slip Roll", "Steady Roll" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 801.0, 648.5, 79.0, 22.0 ],
					"restore" : [ 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 830.76249596706657, 718.0, 29.5, 22.0 ],
					"text" : "t b i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 715.76249596706657, 643.0, 29.5, 22.0 ],
					"text" : "- 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 715.76249596706657, 791.0, 119.0, 89.0 ],
					"text" : ";\rmax launchbrowser https://docs.pioneerdj.com/Manuals/DDJ_FLX10_DRI1822C_manual/?page=96"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 715.76249596706657, 752.0, 134.012470694697186, 35.0 ],
					"suppressinlet" : 1,
					"text" : "inspired by Pioneer\nsee ROLL and SLIP ROLL"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 715.76249596706657, 721.0, 52.0, 22.0 ],
					"text" : "gate 1 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 748.76249596706657, 680.0, 22.0, 22.0 ],
					"text" : "t b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 596.0, 2116.0, 65.0, 22.0 ],
					"text" : "append 30"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 596.0, 2148.0, 48.0, 22.0 ],
					"text" : "line~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 577.0, 1564.0, 58.0, 22.0 ],
					"text" : "ease~ 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 505.0, 1474.0, 34.0, 22.0 ],
					"text" : "*~ 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "float" ],
					"patching_rect" : [ 497.0, 1202.0, 29.5, 22.0 ],
					"text" : "t b f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 497.0, 1171.0, 29.5, 22.0 ],
					"text" : "* 4."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 458.0, 1270.0, 57.0, 22.0 ],
					"text" : "clip 0 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 591.0, 1325.0, 29.5, 22.0 ],
					"text" : "!- 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 505.0, 1367.0, 105.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 541.0, 1605.0, 29.5, 22.0 ],
					"text" : "+~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 505.0, 1564.0, 34.0, 22.0 ],
					"text" : "*~ -1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 505.0, 1523.0, 30.0, 22.0 ],
					"text" : "-~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1787.5, 478.0, 40.0, 22.0 ],
					"text" : "* 127."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 552.0, 1151.0, 76.0, 22.0 ],
					"restore" : [ 10.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 581.0, 1188.0, 66.0, 36.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 209.0, 18.0, 54.0, 36.0 ],
					"saved_attribute_attributes" : 					{
						"activeneedlecolor" : 						{
							"expression" : "themecolor.live_value_arc"
						}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1787.5, 509.0, 72.0, 22.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1819.5, 604.0, 244.0, 22.0 ],
					"text" : "if $f1 > 0.505 || $f1 < 0.495 then $f1 else 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1787.5, 539.0, 25.0, 36.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 178.0, 18.0, 25.0, 36.0 ],
					"saved_attribute_attributes" : 					{
						"activeneedlecolor" : 						{
							"expression" : "themecolor.live_value_arc"
						}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 946.0, 2571.0, 60.0, 22.0 ],
					"text" : "cascade~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 861.0, 2571.0, 60.0, 22.0 ],
					"text" : "cascade~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1032.0, 2396.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 861.0, 2527.0, 71.5, 22.0 ],
					"text" : "biquad~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 946.0, 2527.0, 71.5, 22.0 ],
					"text" : "biquad~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 999.0, 2440.0, 449.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "dictionary" ],
					"patching_rect" : [ 1032.0, 2484.0, 464.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "int" ],
					"patching_rect" : [ 1751.5, 803.0, 68.0, 22.0 ],
					"text" : "change 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "int" ],
					"patching_rect" : [ 1644.0, 803.0, 68.0, 22.0 ],
					"text" : "change 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 2442.0, 684.0, 150.0, 21.0 ],
					"suppressinlet" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1817.5, 722.0, 32.0, 22.0 ],
					"text" : "f 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 1883.5, 874.0, 43.0, 22.0 ],
					"text" : "== 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1728.5, 881.0, 29.5, 22.0 ],
					"text" : "f 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1751.5, 766.0, 57.0, 22.0 ],
					"text" : "clip 0.5 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1644.0, 766.0, 57.0, 22.0 ],
					"text" : "clip 0 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1751.5, 839.0, 87.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1644.0, 839.0, 103.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 1817.5, 1291.0, 100.0, 21.0 ],
					"suppressinlet" : 1,
					"text" : "fine-tune to taste",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1787.5, 450.0, 73.0, 22.0 ],
					"text" : "speedlim 50"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1686.0, 419.0, 178.0, 22.0 ],
					"text" : "r #1\" Stutter Accel (uni)\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1672.0, 1012.0, 100.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "reset" ],
					"patching_rect" : [ 1601.0, 1098.0, 42.0, 22.0 ],
					"text" : "t reset"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 1591.0, 952.0, 34.0, 22.0 ],
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "int" ],
					"patching_rect" : [ 1591.0, 915.0, 48.0, 22.0 ],
					"text" : "change"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 1591.0, 880.0, 43.0, 22.0 ],
					"text" : "== 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 1807.0, 1027.0, 29.5, 22.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "int", "int" ],
					"patching_rect" : [ 1807.0, 940.0, 48.0, 22.0 ],
					"text" : "change"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1881.0, 1027.0, 41.0, 22.0 ],
					"text" : "sig~ 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1807.0, 1076.0, 166.0, 22.0 ],
					"text" : "selector~ 2 1 @ramptime 5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1461.0, 1223.0, 100.0, 22.0 ],
					"text" : "slide~ 1000 1000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1807.0, 1269.133333333333212, 44.0, 22.0 ],
					"text" : "*~ -0.2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1807.0, 1314.0, 78.0, 22.0 ],
					"text" : "clip~ -0.4 0.4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1807.0, 1125.0, 124.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1807.0, 1209.044444444444707, 38.0, 22.0 ],
					"text" : "tanx~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1954.0, 1027.0, 59.0, 22.0 ],
					"text" : "tapout~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1954.0, 978.0, 52.0, 22.0 ],
					"text" : "tapin~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "bang" ],
					"patching_rect" : [ 1461.0, 1347.0, 42.0, 22.0 ],
					"text" : "edge~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1461.0, 1306.0, 40.0, 22.0 ],
					"text" : "==~ 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 396.0, 857.0, 29.5, 22.0 ],
					"text" : "- 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 396.0, 890.0, 159.0, 19.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"parameter_mappable" : 0,
					"patching_rect" : [ 161.0, 2565.0, 44.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 596.0, 2920.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 523.0, 2920.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 541.0, 1675.0, 47.0, 22.0 ],
					"text" : "*~ 0.25"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 138.0, 2527.0, 66.0, 22.0 ],
					"restore" : [ 0.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 161.0, 2607.0, 29.5, 22.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 224.0, 2668.0, 166.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 176.0, 2718.0, 166.0, 22.0 ],
					"text" : "selector~ 2 1 @ramptime 444"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 710.0, 2549.0, 120.0, 22.0 ],
					"restore" : [ 0.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0,
						"parameter_mappable" : 0
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 873.0, 2628.0, 85.0, 136.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 537.0, 2212.0, 34.0, 22.0 ],
					"text" : "*~ -1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 537.0, 2182.0, 30.0, 22.0 ],
					"text" : "-~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 902.76249596706657, 313.0, 121.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 379.0, 566.0, 240.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 396.0, 814.0, 158.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 405.0, 2920.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 332.0, 2920.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 365.0, 2233.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 317.0, 2233.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 541.0, 1908.0, 34.0, 22.0 ],
					"text" : "cos~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 645.0, 1941.0, 160.0, 35.0 ],
					"suppressinlet" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 610.0, 1632.5, 80.0, 35.0 ],
					"suppressinlet" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 191.0, 1831.0, 62.0, 50.0 ],
					"suppressinlet" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 501.0, 2383.0, 90.0, 21.0 ],
					"suppressinlet" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 1059.987529305302814, 514.0, 95.0, 21.0 ],
					"suppressinlet" : 1,
					"text" : "-1 pauses poke~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 312.0, 1966.0, 22.0, 22.0 ],
					"text" : "t 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 251.0, 1966.0, 22.0, 22.0 ],
					"text" : "t 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "bang" ],
					"patching_rect" : [ 312.0, 1842.0, 55.0, 22.0 ],
					"text" : "onebang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "bang", "bang", "" ],
					"patching_rect" : [ 256.0, 1782.0, 44.0, 22.0 ],
					"text" : "sel 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "bang" ],
					"patching_rect" : [ 251.0, 1842.0, 55.0, 22.0 ],
					"text" : "onebang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "bang" ],
					"patching_rect" : [ 326.0, 1782.0, 42.0, 22.0 ],
					"text" : "edge~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "int" ],
					"patching_rect" : [ 326.0, 1741.0, 41.0, 22.0 ],
					"text" : "what~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 596.0, 2182.0, 58.0, 22.0 ],
					"text" : "ease~ 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 819.0, 489.0, 22.0, 22.0 ],
					"text" : "t 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "bang", "bang", "" ],
					"patching_rect" : [ 819.012470694697186, 416.0, 44.0, 22.0 ],
					"text" : "sel 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "bang" ],
					"patching_rect" : [ 903.0, 456.0, 55.0, 22.0 ],
					"text" : "onebang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 903.0, 489.0, 22.0, 22.0 ],
					"text" : "t 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 791.0, 1870.0, 30.0, 22.0 ],
					"text" : "*~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 928.0, 2347.0, 131.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 1074.0, 2347.0, 131.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 825.0, 1903.0, 33.737504867397547, 21.0 ],
					"text" : "sig~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 398.0, 1879.0, 118.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 505.0, 1415.0, 58.0, 22.0 ],
					"text" : "ease~ 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 461.0, 2382.0, 34.5, 20.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 421.0, 2382.0, 34.5, 20.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1863.75, 1154.08888888888896, 106.0, 131.911111111111126 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1226.75, 403.0, 964.0, 1047.5 ],
					"proportion" : 0.5
				}
...
, 			{
				"box" : 				{
					"angle" : 46.218875235131293,
					"background" : 1,
					"grad1" : [ 0.03921568627451, 0.462745098039216, 0.592156862745098, 1.0 ],
					"grad2" : [ 0.701960784313725, 0.32156862745098, 0.254901960784314, 1.0 ],
					"id" : "obj-189",
					"maxclass" : "panel",
					"mode" : 1,
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 686.75, 531.0, 254.0, 367.0 ],
					"proportion" : 0.739914597118653,
					"pt1" : [ -0.227272727272727, 1.282828282828283 ],
					"pt2" : [ 1.050505050505051, -0.050505050505051 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1351.5, 1846.0, 800.5, 1846.0 ],
					"order" : 1,
					"source" : [ "obj-107", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 1351.5, 1719.0, 335.5, 1719.0 ],
					"order" : 3,
					"source" : [ "obj-107", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1483.5, 1422.5, 1785.0, 1422.5, 1785.0, 996.5, 1816.5, 996.5 ],
					"source" : [ "obj-114", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1470.5, 1430.5, 1587.0, 1430.5, 1587.0, 1037.5, 1610.5, 1037.5 ],
					"source" : [ "obj-114", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"color" : [ 0.454795718193054, 0.857914686203003, 0.486182689666748, 1.0 ],
					"destination" : [ "obj-107", 0 ],
					"midpoints" : [ 1610.5, 1134.5, 1548.0, 1134.5, 1548.0, 988.5, 1351.5, 988.5 ],
					"source" : [ "obj-125", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1470.5, 1294.5, 1446.0, 1294.5, 1446.0, 1437.5, 2030.0, 1437.5, 2030.0, 947.5, 1963.5, 947.5 ],
					"order" : 0,
					"source" : [ "obj-28", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"midpoints" : [ 751.25, 413.0, 265.5, 413.0 ],
					"order" : 2,
					"source" : [ "obj-38", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 813.5, 1985.0, 619.75, 1985.0, 619.75, 1862.0, 407.5, 1862.0 ],
					"source" : [ "obj-720", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1816.5, 1346.5, 1772.0, 1346.5, 1772.0, 969.5, 1692.5, 969.5 ],
					"source" : [ "obj-97", 0 ]
				}
